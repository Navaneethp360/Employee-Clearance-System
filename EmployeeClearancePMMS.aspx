<%@ Page Title="Employee Clearance" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeClearancePMMS.aspx.cs" Inherits="MedicalSystem.EmployeeClearance" %>
...
<div class="page-content">
    <div class="page-header">
        <h2>🛡️ Employee Clearance Check</h2>
    ...
    <div class="connections">
        <asp:Label ID="conn1" runat="server" CssClass="connection-box">Connection 1</asp:Label>
        <asp:Label ID="conn2" runat="server" CssClass="connection-box">Connection 2</asp:Label>
        <asp:Label ID="conn3" runat="server" CssClass="connection-box">Connection 3</asp:Label>
        <asp:Label ID="conn4" runat="server" CssClass="connection-box">Connection 4</asp:Label>
        <asp:Label ID="conn5" runat="server" CssClass="connection-box">Connection 5</asp:Label>
    </div>
</div>
